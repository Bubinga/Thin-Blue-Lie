...
GM_addStyle(`.imagus-video-wrapper {
...
video.custom-native-player + controls btn.expand {
  font-size: 20px!important;
  font-weight: bold!important;
}
video.custom-native-player + controls btn.skip-long {
  font-size: 18px!important;
}
video.custom-native-player + controls btn.skip-short {
  font-size: 12px!important;
}
video.custom-native-player + controls btn.begin {
  font-size: 18px!important;
}
video.custom-native-player + controls btn.mute {
